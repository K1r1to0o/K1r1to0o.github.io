...
image:
  path: /assets/img/revil-gold-southfield-lab-walkthrough/cover.png
...
![Event id 1 query result](/assets/img/revil-gold-southfield-lab-walkthrough/powershell.png){: w="900" h="500" }
...
- Process name: **facebook assistant.exe**
- Process path: **C:\Users\Administrator\Downloads\facebook assistant.exe**
- PID: **5348**
- Hashes:
...
![Powershell event result](/assets/img/revil-gold-southfield-lab-walkthrough/event.png){: w="900" h="500" }
...
![PID search result](/assets/img/revil-gold-southfield-lab-walkthrough/PID.png){: w="900" h="500" }
